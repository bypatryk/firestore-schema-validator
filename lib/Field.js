...
class Field {
  ...
  async validate(fieldData) {
    ...
    if (this._objectOf)
      fieldData = this._objectOf instanceof Schema
        ? await this._objectOf.validate(fieldData)
        : await this.validateObject(fieldData)
   ...
   *
   * @param {Field|Schema} fieldOrSchema Field or Schema.
   * @param {*} args
   * @returns {this}
   * @memberof Field
   */
  arrayOf(fieldOrSchema, ...args) {
    this._defineType()
    this._arrayOf = fieldOrSchema
   ...
   *
   * @param {Object<Field>|Schema} objectOfFieldsOrSchema Object of Fields or Schema.
   * @param {*} args
   * @returns {this}
   * @memberof Field
   */
  objectOf(objectOfFieldsOrSchema, ...args) {
    this._defineType()
    this._objectOf = objectOfFieldsOrSchema
